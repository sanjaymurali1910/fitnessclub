...
urlpatterns = [
    ...
    re_path(r'^userpayment/$', views.userpayment, name='userpayment'),
    ...
    re_path(r'^admin_edit_timetable/(?P<id>\d+)/$', views.admin_edit_timetable, name='admin_edit_timetable'),
    re_path(r'^admin_editpage/(?P<id>\d+)/$', views.admin_editpage, name='admin_editpage'),
    re_path(r'^delete_batch/(?P<id>\d+)/$', views.delete_batch, name='delete_batch'),
